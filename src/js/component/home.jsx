...
const Todo = () => {
    ...
    function putApi() {
        ...
        fetch(
            "https://assets.breatheco.de/apis/fake/todos/user/tamara",
            requestOptions
        )
    ...
    useEffect(() => {
        fetch("https://assets.breatheco.de/apis/fake/todos/user/tamara")
    ...
    return (
        <div className="container">
            ...
            <div className="left">
        	    <p>Faltan {tareas.length} por finalizar.</p>
    	    </div>
        </div>
    );
};
